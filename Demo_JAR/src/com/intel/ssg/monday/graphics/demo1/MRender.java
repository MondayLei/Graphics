...
import com.intel.s3d.S3D;

import edu.sjtu.stap.monday.util.Util;
...
public class MRender implements Renderer {
	...
	public void onDrawFrame(GL10 gl) {
		...
		// ScreenSplitLibJNIWrapper.on_draw_frame();
		...
		//Util.printLine("Android Test Jar");
		 S3D.RenderS3D(this, "draw_test");
...
//		GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, 3);
	...
	private void draw_test(Object... args) {
		GLES20.glDrawArrays(GLES20.GL_TRIANGLES, 0, 3);
	}
